      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8 pb-4 border-b border-[#E5E8E2]">
          ...
          <button
            ...
            className="inline-flex items-center space-x-1 text-xs font-bold uppercase tracking-wider text-[#3d4d38] hover:text-[#2a3726] underline underline-offset-4 transition"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {news.map((item) => (
            <div
              ...
              className="group cursor-pointer bg-white rounded-2xl overflow-hidden border border-[#E5E8E2] hover:border-[#3d4d38] hover:shadow-xl transition-all duration-300 flex flex-col justify-between"
            >
              <div>
                <div className="aspect-[16/10] w-full bg-gray-100 overflow-hidden relative">
                  ...
                  />
                  <div className="absolute top-3 left-3 bg-[#3d4d38] text-white text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                    {item.category}
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <h3 className="font-bold text-base text-[#1D241B] group-hover:text-[#3d4d38] transition line-clamp-2 leading-snug mb-2">
                    {item.title}
                  </h3>
              ...
              <div className="px-6 pb-6 pt-0">
                <span className="inline-flex items-center space-x-1 text-xs font-bold text-[#3d4d38] group-hover:underline">
      ...
      {selectedNews && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 sm:p-8 relative border border-gray-200 shadow-2xl animate-in zoom-in-95">
            ...
            <span className="text-xs font-bold uppercase tracking-wider text-[#3d4d38] bg-[#FAFBF9] px-3 py-1 rounded-full border border-[#3d4d38]/20">
            ...
            <div className="flex items-center space-x-2 text-xs text-gray-400 mb-6">
              <Calendar className="w-4 h-4 text-[#3d4d38]" />
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end">
              <button
                onClick={() => setSelectedNews(null)}
                className="bg-[#3d4d38] text-white px-6 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider"
              >
                Tutup Artikel
              </button>
            </div>
