    ...
    <div className="bg-[#FAFBF9] min-h-screen py-12 text-[#1D241B]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 font-light space-y-6 leading-relaxed mb-12">
          ...
          <p>
            Dengan filosofi <strong className="font-semibold text-[#3d4d38]">"Bersih Maksimal, Lembut Di Tangan"</strong>, Cleanza menghadirkan varian kemasan praktis rumah tangga (450ml & 1000ml) serta kemasan jeriken ekonomis Cleanza Profesional (5000ml) khusus untuk restoran, katering, dan usaha kuliner.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
            <ShieldCheck className="w-8 h-8 text-[#3d4d38] mb-3" />
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
            <Leaf className="w-8 h-8 text-[#3d4d38] mb-3" />
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
            <Droplets className="w-8 h-8 text-[#3d4d38] mb-3" />
        ...
        <div className="text-center pt-8 border-t border-gray-200">
          <button
            ...
            className="bg-[#3d4d38] hover:bg-[#2a3726] text-white font-bold text-xs uppercase tracking-widest px-8 py-4 rounded-xl shadow-lg transition inline-flex items-center space-x-2"
          >
